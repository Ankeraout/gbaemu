...
namespace gbaemu::gba::cpu::impl::arm::bdt {
    ...
    DEFINE_BDT_OPCODE(ldmdaw, HEADER_DA, BODY_LDM, FOOTER_WRITEBACK)
    DEFINE_BDT_OPCODE(ldmdas, HEADER_DA; HEADER_LDM_S, BODY_LDM_S, FOOTER_LDM_S)
    DEFINE_BDT_OPCODE(ldmdasw, HEADER_DA; HEADER_LDM_S, BODY_LDM_S, FOOTER_WRITEBACK; FOOTER_LDM_S)
    DEFINE_BDT_OPCODE(ldmia, HEADER_IA, BODY_LDM, )
    DEFINE_BDT_OPCODE(ldmiaw, HEADER_IA, BODY_LDM, FOOTER_WRITEBACK)
    DEFINE_BDT_OPCODE(ldmias, HEADER_IA; HEADER_LDM_S, BODY_LDM_S, FOOTER_LDM_S)
    DEFINE_BDT_OPCODE(ldmiasw, HEADER_IA; HEADER_LDM_S, BODY_LDM_S, FOOTER_WRITEBACK; FOOTER_LDM_S)
    ...
    DEFINE_BDT_OPCODE(ldmdbsw, HEADER_DB; HEADER_LDM_S, BODY_LDM_S, FOOTER_WRITEBACK; FOOTER_LDM_S)
    ...
    DEFINE_BDT_OPCODE(ldmibsw, HEADER_IB; HEADER_LDM_S, BODY_LDM_S, FOOTER_WRITEBACK; FOOTER_LDM_S)

    DEFINE_BDT_OPCODE(stmda, HEADER_DA, BODY_STM, )
    DEFINE_BDT_OPCODE(stmdaw, HEADER_DA, BODY_STM, FOOTER_WRITEBACK)
    DEFINE_BDT_OPCODE(stmdas, HEADER_DA, BODY_STM_S, )
    DEFINE_BDT_OPCODE(stmdasw, HEADER_DA, BODY_STM_S, FOOTER_WRITEBACK)
    DEFINE_BDT_OPCODE(stmia, HEADER_IA, BODY_STM, )
    DEFINE_BDT_OPCODE(stmiaw, HEADER_IA, BODY_STM, FOOTER_WRITEBACK)
    DEFINE_BDT_OPCODE(stmias, HEADER_IA, BODY_STM_S, )
    DEFINE_BDT_OPCODE(stmiasw, HEADER_IA, BODY_STM_S, FOOTER_WRITEBACK)
