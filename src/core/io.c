...
void gba_io_reset() {
    ...
    gba_io_initRegister(0x040000ba, 0x0000, NULL, 0xffe0, 0xffe0); // DMA0CNT_H
    ...
    gba_io_initRegister(0x040000c6, 0x0000, NULL, 0xffe0, 0xffe0); // DMA1CNT_H
    ...
    gba_io_initRegister(0x040000d2, 0x0000, NULL, 0xffe0, 0xffe0); // DMA2CNT_H
