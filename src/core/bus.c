...
const t_busOperationHandlers s_busOperationHandlers[16] = {
    ...
    {
        .read8 = cartridgeRamRead8,
        .read16 = cartridgeRamRead16,
        .read32 = cartridgeRamRead32,
        .write8 = cartridgeRamWrite8,
        .write16 = cartridgeRamWrite16,
        .write32 = cartridgeRamWrite32
    },
