        ...
        private void InitRegisters() {
            ...
            for(int i = 0; i < 512; i++) {
                switch(0x04000000 | (i << 1)) {
                    ...
                    case 0x04000010: registers[i] = new Register(0x0000, null, 0x0000, 0x03ff); break; // BG0HOFS
                    case 0x04000012: registers[i] = new Register(0x0000, null, 0x0000, 0x03ff); break; // BG0VOFS
                    case 0x04000014: registers[i] = new Register(0x0000, null, 0x0000, 0x03ff); break; // BG1HOFS
                    case 0x04000016: registers[i] = new Register(0x0000, null, 0x0000, 0x03ff); break; // BG1VOFS
                    case 0x04000018: registers[i] = new Register(0x0000, null, 0x0000, 0x03ff); break; // BG2HOFS
                    case 0x0400001a: registers[i] = new Register(0x0000, null, 0x0000, 0x03ff); break; // BG2VOFS
                    case 0x0400001c: registers[i] = new Register(0x0000, null, 0x0000, 0x03ff); break; // BG3HOFS
                    case 0x0400001e: registers[i] = new Register(0x0000, null, 0x0000, 0x03ff); break; // BG3VOFS
